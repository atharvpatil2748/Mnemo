...
- **GOVERNING DOCUMENTS:**
  - `docs/architecture/current/mnemo_architecture_v2.md` §5.2 (MCP Server Integration)
  - `docs/architecture/current/mnemo_engineering_roadmap.md` §Phase 8, Module 8.3 & Milestone M8
  - `docs/adr/active/ADR-0049-phase-7-server-application-architecture.md`
  - `docs/modules/module-8/MODULE_8_1_CLOSURE_REPORT.md`
  - `docs/modules/module-8/MODULE_8_2_CLOSURE_REPORT.md`
