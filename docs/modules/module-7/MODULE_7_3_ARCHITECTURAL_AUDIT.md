...
- **Governing Architecture:** `docs/architecture/current/mnemo_architecture_v2.md` (§5.1, §9) & `docs/architecture/current/mnemo_engineering_roadmap.md` (§Phase 7)
...
All error translations conform 100% to [ADR-0049](../../adr/active/ADR-0049-phase-7-server-application-architecture.md).
