...
- **Authoritative Contract:** [ADR-0051: Sources & Document Ingestion REST API Specification](../../adr/active/ADR-0051-sources-and-document-ingestion-rest-api.md)
