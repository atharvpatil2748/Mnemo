...
- **Authoritative References:**
  - `docs/architecture/current/mnemo_engineering_roadmap.md` (Module 7.6)
  - `docs/architecture/current/mnemo_architecture_v2.md` §5.1 (System endpoints: health, config, config/models, jobs)
