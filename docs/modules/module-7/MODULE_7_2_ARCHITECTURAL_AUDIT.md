...
- **Authoritative References:** `docs/architecture/current/mnemo_engineering_roadmap.md`, `docs/architecture/current/mnemo_architecture_v2.md`, ADR-0001 through ADR-0049
...
From `docs/architecture/current/mnemo_engineering_roadmap.md` §7 (Module 7.2):
...
From `docs/architecture/current/mnemo_architecture_v2.md` §5.1 (REST API Surface):
- Versioned at `/v1`.
...
docs/architecture/current/mnemo_engineering_roadmap.md  ← Update Module 7.2 task status upon completion
```
