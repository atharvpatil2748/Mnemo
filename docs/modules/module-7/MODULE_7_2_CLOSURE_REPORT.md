...
- **Status:** COMPLETE
- **Authoritative Contract:** [ADR-0050: Notebook and Knowledge Graph REST API Specification](../../adr/active/ADR-0050-notebook-and-knowledge-graph-rest-api.md)
