...
- **Authoritative References:**
  - `docs/architecture/current/mnemo_architecture_v2.md` §4.3, §5.1
  - `docs/architecture/current/mnemo_engineering_roadmap.md` Phase 7, Module 7.5 & Phase 10
  ...
  - `docs/adr/active/ADR-0051-sources-and-document-ingestion-rest-api.md`
