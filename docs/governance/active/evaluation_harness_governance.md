...
### Forensic Finding
- The authoritative `mnemo-core` production diversity ranker ([`mnemo.retrieval.reranker._apply_diversity_ordering`](../../../mnemo-core/mnemo/retrieval/reranker.py#L595)) was completely intact and behaving strictly according to ADR-0048:
