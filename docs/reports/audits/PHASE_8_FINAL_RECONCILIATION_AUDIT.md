...
- **AUTHORITATIVE_STANDARDS:**
  - `docs/architecture/current/mnemo_architecture_v2.md` §5.2 (Model Context Protocol Architecture)
  - `docs/architecture/current/mnemo_engineering_roadmap.md` §Phase 8 & Milestone M8
  - `docs/adr/ADR-0044` through `ADR-0051` (Grounding, Ingestion, and Server Protocols)
  - `docs/modules/module-8/MODULE_8_3_CLOSURE_REPORT.md`
