...
- **Supersedes:** None
- **Related Documents:**
  - `docs/architecture/current/mnemo_architecture_v2.md` (§5.1 REST API Surface, §9 Document Ingestion Pipeline)
  - `docs/architecture/current/mnemo_engineering_roadmap.md` (§Phase 7 REST API)
  ...
  - `docs/adr/active/ADR-0011-raw-parse-result-boundary.md`
  - `docs/adr/active/ADR-0013-classifier-boundary.md`
  ...
  - `docs/adr/active/ADR-0050-notebook-and-knowledge-graph-rest-api.md`
  - `docs/modules/module-7/MODULE_7_3_ARCHITECTURAL_AUDIT.md`
  - `docs/modules/module-7/MODULE_7_3_TARGETED_RECONCILIATION.md`
