...
- **Supersedes:** None
- **Related Documents:**
  - `docs/architecture/current/mnemo_architecture_v2.md` (§5.1 REST API Surface, §5.2 MCP Server)
  - `docs/architecture/current/mnemo_engineering_roadmap.md` (§7 mnemo-server, §10 Notebook Features, §12 Plugins)
  - `docs/adr/active/ADR-0001-domain-model-specification.md`
  - `docs/adr/active/ADR-0002-core-interface-contracts.md`
  ...
  - `docs/adr/active/ADR-0049-phase-7-server-application-architecture.md`
  - `docs/modules/module-7/MODULE_7_2_ARCHITECTURAL_AUDIT.md`
  - `docs/modules/module-7/MODULE_7_2_ADVERSARIAL_FORENSIC_REVIEW.md`
...
Before implementation begins, the HTTP REST contract must be formally frozen. A comprehensive adversarial forensic audit (`docs/modules/module-7/MODULE_7_2_ADVERSARIAL_FORENSIC_REVIEW.md`) identified several critical architectural boundaries and two roadmap scope corrections that must be explicitly codified:
