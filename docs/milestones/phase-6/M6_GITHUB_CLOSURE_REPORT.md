...
- **Evaluation Harness Governance = Enforced:** Institution of [`evaluation_harness_governance.md`](../../governance/active/evaluation_harness_governance.md) permanently prohibits evaluation harnesses from independently reimplementing retrieval, reranking, diversity, Top-K selection, or context construction.
