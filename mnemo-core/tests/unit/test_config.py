...
_RECOGNIZED_ENVIRONMENT_NAMES = (
    ...
    "MNEMO_MODELS_VISION_ENABLED",
    "MNEMO_MODELS_VISION_PROVIDER",
    "MNEMO_MODELS_VISION_MODEL",
    "MNEMO_MODELS_VISION_REVISION",
    ...
    "MNEMO_PHASE85_ENABLED",
    "MNEMO_PHASE85_PROFILE_FILE",
    "MNEMO_PHASE85_PROFILE_NAME",
    "MNEMO_PHASE85_MODEL_ROOT",
    "MNEMO_PHASE85_ADVANCED_RETRIEVAL_ENABLED",
    "MNEMO_PHASE85_STRUCTURED_RETRIEVAL_ENABLED",
    "MNEMO_PHASE85_OCR_ENABLED",
    "MNEMO_PHASE85_VISION_ENABLED",
    ...
    "MNEMO_PHASE85_HTTP_ENABLED",
    "MNEMO_PHASE85_MCP_ENABLED",
