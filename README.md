...
Here is the current implementation status (Module 4.2 complete; latest frozen
release v0.12.0):
...
| Chunking Engine | 🚧 In progress | Modules 4.1–4.2 complete: deterministic dispatcher plus Generic strategy |
