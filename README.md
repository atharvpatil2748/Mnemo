...
Here is the current implementation status (Module 4.6 complete; latest frozen
release v0.16.0):
...
| Chunking Engine | 🚧 In progress | Modules 4.1–4.6 complete: dispatcher plus Generic, Book, Paper, Code, and Markdown strategies |
